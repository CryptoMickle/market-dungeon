...
The [1080p film](https://github.com/CryptoMickle/market-dungeon/releases/download/hackathon-submission-2026-v16/Market-Dungeon-Competition-V3-1080p.mp4), [English SRT captions](https://github.com/CryptoMickle/market-dungeon/releases/download/hackathon-submission-2026-v16/Market-Dungeon-Competition-V3-EN.srt) and [transcript](https://github.com/CryptoMickle/market-dungeon/releases/download/hackathon-submission-2026-v16/Market-Dungeon-Competition-V3-Transcript-EN.txt) are published as v16 GitHub release assets. The [YouTube film](https://youtu.be/kkFKUrC-fYk) is public, with 1080p playback and English closed captions checked. DoraHacks uses the same film in its published description and demo-video field; see the [film record](COMPETITION_VIDEO_2026-09-11.md). The older [1:52 baseline](https://youtu.be/6IviQrMweZ4) is retained as historical material, not the current Live Judge demonstration.

The event guidance checked on September 10 requested a working testnet prototype, GitHub repository and 2–3 minute demo video. The new film is within that duration. The film is publicly available on YouTube and GitHub, and the DoraHacks entry has been updated and reloaded for verification. See [official event details](https://dorahacks.io/hackathon/event-contracts/detail).
