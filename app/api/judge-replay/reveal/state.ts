...
export function createReplayRevealStore() {
...
const mainnetRevealStore = createReplayRevealStore();
export const dedupeReveal = mainnetRevealStore.dedupe;
export const resetReplayRevealStateForTests = mainnetRevealStore.reset;
